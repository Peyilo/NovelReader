...
public abstract class BaseReadView<E extends View> extends ViewGroup {
     ...
     */
    protected E getPageView(int offset) {
        return (E) getChildAt(curPagePointer - offset);
    }
            ...
            case MotionEvent.ACTION_UP:
                if (initialDirection != PageDirection.NONE) {
                    ...
                    if (endDirection == PageDirection.TO_NEXT) {
                        ...
                        E convertView = getPageView(-getPrevViewCount());
                        E newView = getView(convertView, endDirection);
                        if (newView != null) {
                        ...
                        E convertView = getPageView(getNextViewCount());
                        E newView = getView(convertView, endDirection);
                        if (newView != null) {
                            removeView(convertView);
    ...
    protected abstract E getView(E convertView, PageDirection direction);
